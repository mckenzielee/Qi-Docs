...
removed from an existing topic. 
...
+=================+=========================+========================================+
| TenantId        | string                  | Identifies the tenant for the Topic    |
+-----------------+-------------------------+----------------------------------------+
...
``GET api/tenants/{tenantId}/namespaces/{namespaceId}/publishertopicmappings/publisher/{publisherId}``
--------------------------------------------------------------------------
